...
mediapath, templatepath = map(fillPath, ['media', 'templates'])
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sahyog',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'efbi43ik78iiqvl=py+0)1onze0qk7(5z7pzp@en1src3ky4dj'
